...
export default function AdvancedAnalyticsPage() {
  ...
  return <PageTransition><div className="p-4 md:p-8 max-w-7xl mx-auto space-y-8">
    ...
    {hasPremium === false && <div className="rounded-2xl border border-amber-200 bg-amber-50 p-8 text-center dark:border-amber-900/40 dark:bg-amber-950/20"><h2 className="text-xl font-bold text-foreground">Agent Premium required</h2><p className="mt-2 text-muted-foreground">Performance Analytics is available on the ₦10,000 per annum Agent Premium plan as a one-time payment. No metrics are shown until the entitlement is active.</p><a href="/agent/premium" className="mt-5 inline-flex rounded-lg bg-[#008A4B] px-4 py-2 font-semibold text-white">View Agent Premium</a></div>}
    {hasPremium && <>
