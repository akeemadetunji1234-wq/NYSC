...
const CATEGORY_CONFIG = {
  ...
  hospital: {
    queries: ["hospital", "clinic", "medical center", "medical centre", "doctor", "health centre", "dentist", "laboratory", "emergency room"],
    osmFilters: [
      '["amenity"="hospital"]',
      '["amenity"="clinic"]',
      '["amenity"="doctors"]',
  ...
  bank: {
    queries: ["bank", "atm", "cashpoint", "financial institution", "microfinance bank", "bureau de change", "POS"],
    osmFilters: [
      '["amenity"="bank"]',
      '["amenity"="atm"]',
