        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          {items.length > 0 ? (
            ...
            <div className="bg-card border border-border rounded-2xl p-8 shadow-sm space-y-6 text-sm text-muted-foreground leading-relaxed">
              ...
              <section className="space-y-3"><h2 className="text-lg font-bold text-foreground">3. Booking and Payments</h2><p>Bookings must be completed through the platform. Do not send funds outside an official, confirmed payment flow.</p></section>
